document.querySelector("#loadPost").addEventListener("click", () => {
    ...
    const loadUsers = () => {
     ...
     //click event çalıştığında görünmesi için display block yaptım.

     //setTimeout ekleyerek 1,5 saniye sonra listenin yüklenmesini sağladım.
     setTimeout(() => {
     loadingGif.style.display ="none"
     //Bu aşamada display none yaparak liste görüntülendikten sonra gifin gizlenmesini sağladım.   
    ...
    const renderUsers = (users = []) => {
      ...
      <th scope="col">Id</th>
        ...
        <th scope="col" id="name-reverse">Name</th>
        <th scope="col">Email</th>
        <th scope="col">Phone</th>
        <th scope="col">Website</th>
      ...
      //reverse metodu ekledim.
      document.querySelector("#name-reverse").addEventListener("click", reverseName)
